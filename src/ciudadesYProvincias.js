export const zonas = [
  {
    ...
    items: [
      300413, //Basavilbaso
      300238, //Borvril
      300427, //Concepción del Uruguay
      300420, //Caseros
      300007, //Colon
      300042, //Concordia
      300140, //Conscripto Bernardi
      300112, //Federación
      300147, //Federal
      300378, //General Campos
      300308, //Hasenkamp
      300063, //Los Charrúas
      300322, //María Grande
      300287, //Nogoyá
      300336, //Paraná
      300483, //Villa Dominguez
      309030, //Pueblo Liebig
      300406, //Rosario del Tala
      300119, //San Jaime
      100203, //San José
      300385, //San Salvador
      300154, //Sauce de Luna
      300021, //Ubajay
      300364, //Viale
      300231, //Alcaraz
      300028, //Villa Elisa
    ...
    items: [
      ...
      540511, //Alba Posse
      540007, //Apóstoles
      540035, //Aristóbulo del Valle
      540175, //Bernardo de Irigoyen
      540280, //Leando N. Alem
      540182, //Comandante Andresito
      540042, //Campo Grande
      540364, //Campo Viera
      540294, //Capioví
      540259, //Cerro Azul
      ...
      540336, //Caraguatay
      540231, //Colonia Wanda
      540301, //El Alcázar
      540196, //El Soberbio
      540154, //Eldorado
      540308, //Garuhapé
      540112, //Garupá
      540378, //General Alvear
      540441, //Gobernador Roca
      540385, //Guaraní
      540455, //Jardín América
      540343, //Montecarlo
      540399, //Oberá
      540406, //Panambí
      540350, //Puerto Piray
      540119, //Posadas
      540210, //Puerto Esperanza
      540217, //Puerto Iguazú
      540322, //Puerto Rico
      540329, //Ruiz de Montoya
      544321, //Villa Salto Encantado
      540189, //San Antonio
      180182, //San Carlos
      540462, //San Ignacio
      540497, //San Javier
    ...
    items: [
      ...
      900070, //Bella Vista
      180021, //Corrientes
      180063, //Curuzú Cuatiá
      220308, //Coronel Du Graty
      180077, //Empedrado
      180140, //Goya
      180147, //Itatí
      60410, //Ituzaingó
...
export const ciudades = [
  {
    ...
    id: 340063,
    nombre: "Misión San Francisco de Laishi",
    provincia: {
      id: 34,
      nombre: "Formosa"
    }
    ...
    id: 908462,
    nombre: "El Polear y Los Córdoba",
    provincia: {
      id: 90,
      nombre: "Tucumán"
    }
    ...
    id: 660077,
    nombre: "San José de los Cerrillos",
    provincia: {
      id: 66,
      nombre: "Salta"
    }
    ...
    id: 460084,
    nombre: "General Ortiz de Ocampo",
    provincia: {
      id: 46,
      nombre: "La Rioja"
    }
    ...
    id: 309143,
    nombre: "Colonia Santa María y Las Margaritas",
    provincia: {
      id: 30,
      nombre: "Entre Ríos"
    }
    ...
    id: 300189,
    nombre: "San José de Gualeguaychú",
    provincia: {
      id: 30,
      nombre: "Entre Ríos"
    }
    ...
    id: 340077,
    nombre: "Ingeniero Guillermo Nicasio Juárez",
    provincia: {
      id: 34,
      nombre: "Formosa"
    }
    ...
    id: 309440,
    nombre: "Colonia Oficial Nº 3 y 14",
    provincia: {
      id: 30,
      nombre: "Entre Ríos"
    }
    ...
    id: 180042,
    nombre: "Concepción del Yaguareté Corá",
    provincia: {
      id: 18,
      nombre: "Corrientes"
    }
    ...
    id: 180175,
    nombre: "San Antonio Isla Apipé Grande",
    provincia: {
      id: 18,
      nombre: "Corrientes"
    }
    ...
    id: 180336,
    nombre: "Santa Ana de los Guácaras",
    provincia: {
      id: 18,
      nombre: "Corrientes"
    }
    ...
    id: 309007,
    nombre: "Colonia San Anselmo y Aledañas",
    provincia: {
      id: 30,
      nombre: "Entre Ríos"
    }
