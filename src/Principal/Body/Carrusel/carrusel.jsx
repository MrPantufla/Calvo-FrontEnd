...
export default function Carrusel() {
  ...
  const [visualizandoCambios, setVisualizandoCambios] = useState(false);
                ...
                return (
                  ...
                  (
                    <Carousel.Item key={imageName}>
                      ...
                      />
                      {state.userInfo && !visualizandoCambios && (state.userInfo.tipo_usuario == 'admin' || state.userInfo.tipo_usuario == 'colaborador') &&
                        (
                          <>
                      ...
                      {state.userInfo?.tipo_usuario == 'admin' && <button className="previsualizarCambios" onClick={() => setVisualizandoCambios(!visualizandoCambios)}>{visualizandoCambios ? (<svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" fill="currentColor" class="bi bi-eye-slash" viewBox="0 0 16 16">
                        ...
                        :
                        (<svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                      ...
                      {
                        ((state.userInfo?.tipo_usuario != 'admin' || visualizandoCambios) && imageName.endsWith("imagenAviso.webp")) &&
                        (<>
