...
export default function Paginacion(args){
    ...
    return(
        <div className="paginacion">
          ...
          {args.numerosDePagina.map((numero) => {
            ...
            if (isMobile) {
              ...
              mostrarPagina =
                (args.paginaActual <= args.totalPaginas - 2 && numero >= args.paginaActual && numero <= args.paginaActual + 2) ||
                (args.paginaActual > args.totalPaginas - 2 && numero >= args.totalPaginas - 2);
            } else {
              // Lógica para mostrar botones según el caso actual
              mostrarPagina = args.totalPaginas <= 5 ||
                (args.paginaActual <= 3 && numero <= 5) ||
                (args.paginaActual >= args.totalPaginas - 2 && numero >= args.totalPaginas - 4) ||
                (diff <= 2 && args.totalPaginas >= 5);
            }
          ...
          <button
            ...
            onClick={() => args.paginar(args.totalPaginas)}
            disabled={args.paginaActual === args.totalPaginas}
          >
