                ...
                <div className="nombreSrubro">
                    ...
                    <div className="textoSrubro">
                        ...
                        <p className="flechaSrubroContainer">
                            {(rubro.id != 'Maquinas' && rubro.id != 'PuertasPlacas' && rubro.id != 'Automatismos' && rubro.id != 'Chapas' && rubro.id != 'Herramientas' && rubro.id != 'TejidosMosquiteros' && args.srubro.colores && args.srubro.colores.length > 0 && !args.sinColores) &&
